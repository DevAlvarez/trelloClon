<template>
    ...
    <div>
        <div v-if="!editing" class="group bg-white shadow-card  rounded-sm p-2 cursor-pointer text-sm hoverbg-gray-100 mb-2 flex justify-between">
            <div>{{card.title}}</div>
            ...
            >
                <div class="text-gray-400 pr-2 hover:text-yellow-300" @click="editing=true">E</div>
